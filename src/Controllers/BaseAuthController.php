...
use Tir\User\Mail\Welcome;
use Tir\User\Entities\Role;
use Tir\User\Entities\User;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Mail;
use Tir\User\Mail\ResetPasswordEmail;
use Tir\User\Contracts\Authentication;
use Tir\User\Http\Requests\LoginRequest;
use Tir\User\Http\Requests\RegisterRequest;
use Tir\User\Http\Requests\PasswordResetRequest;
use Tir\User\Http\Requests\ResetCompleteRequest;
...
abstract class BaseAuthController extends Controller
{
     ...
     *
     * @var \Tir\User\Contracts\Authentication
     */
    protected $auth;

    /**
     * @param \Tir\User\Contracts\Authentication $auth
     */
     ...
     * Login a user.
     *
     * @param \Tir\User\Http\Requests\LoginRequest $request
     * @return \Illuminate\Http\Response
     */
     ...
     * Register a user.
     *
     * @param \Tir\User\Http\Requests\RegisterRequest $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param \Tir\User\Http\Requests\PasswordResetRequest $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param \Tir\User\Entities\User $user
     * @param string $code
     * @return string
     */
     ...
     * @param string $email
     * @param string $code
     * @param \Tir\User\Http\Requests\ResetCompleteRequest $request
     * @return \Illuminate\Http\Response
     */
